...
class MovementUserAssociation(db.Model):
    ...
    follower = db.relationship("User", foreign_keys=[follower_id], back_populates="follower_associations")
    ...
    def __repr__(self):
        return f"<Association id={self.id} follower={self.follower} leader={self.leader}>"
